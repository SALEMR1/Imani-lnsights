...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const morningAzkar = [
        ...
        },
        {
            ...
            count: 100,
            reference: "من قالها عشر مرات كان كمن أعتق أربعة أنفس من ولد إسماعيل، ومن قالها مائة مرة كتبت له مائة حسنة، ومحيت عنه مائة سيئة، وكانت له حرزاً من الشيطان. [رواه البخاري ومسلم]"
        }
    ];

    // الحصول على عنصر حاوية أذكار الصباح
    const morningContainer = document.getElementById('morning-azkar');
    
    // التحقق من وجود الحاوية
    if (!morningContainer) {
        console.error('لم يتم العثور على حاوية أذكار الصباح');
        return;
    }
    ...
    morningAzkar.forEach(zikr => {
        ...
        morningContainer.appendChild(zikrCard);
    });
});
